...
#  author: example42
#     url: https://github.com/example42/puppet-modules/blob/master/apt/manifests/repository.pp
#   descr: add repository to /etc/apt/sources.list.d
#
#   usage:
#  apt::repository { "name":
#      url => 'repository url',
...
#
# example: 
#   to add the standard Ubuntu Lucid repository, you can use
#
